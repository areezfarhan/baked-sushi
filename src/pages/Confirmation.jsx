    ...
    <div className="min-h-screen bg-warm-50 py-12 px-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-text-main mb-3">Order Placed!</h1>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6 mb-6 border border-warm-100">
          <p className="text-sm font-medium text-text-muted uppercase tracking-wider mb-3 text-center">
            Your Order Reference
          </p>
          <div className="bg-warm-50 rounded-xl p-5 mb-4 text-center">
            <h2 className="text-3xl font-bold text-primary tracking-wide mb-1">
              {ref}
            </h2>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="py-3 px-4 rounded-xl font-semibold text-sm bg-warm-100 text-text-main hover:bg-warm-200 transition-all flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* WhatsApp Button */}
        <div className="mb-8">
          <p className="text-text-main font-medium mb-4 text-center">
            Want to let us know you've ordered?
          </p>
          <a href={waLink} target="_blank" rel="noopener noreferrer" className="block">
            <button className="btn-primary w-full py-4 text-base font-bold flex items-center justify-center gap-3">
        ...
        <div className="text-center">
          <Link to="/" className="text-primary font-medium hover:text-primary-dark transition-colors inline-flex items-center gap-2">
