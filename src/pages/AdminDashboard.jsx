    ...
    <div className="min-h-screen bg-warm-100 pb-24">
        ...
        <div className="max-w-5xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="p-2 text-text-body hover:text-accent transition-colors"
              title="Logout"
            >
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-warm-50 p-4 rounded-2xl shadow-soft border border-warm-200">
        ...
        {orders.length === 0 ? (
          <div className="bg-warm-50 p-12 rounded-2xl shadow-soft border border-warm-200 text-center">
            ...
            <p className="text-text-muted">No pending orders at the moment.</p>
          </div>
        ) : (
          <div className="space-y-4">
            {orders.map(order => (
              <div key={order.id} className="bg-warm-50 rounded-2xl shadow-soft border-2 border-gray-300 overflow-hidden">
                {/* Order Header */}
                <div className="bg-primary/5 px-4 py-3 border-b border-warm-200">
                  <div className="flex items-center justify-between">
                ...
                <div className="p-4 space-y-4">
                  ...
                  {order.notes && order.notes.trim() !== '' && (
                    <div className="mt-3 p-3 bg-accent/5 border border-accent/20 rounded-xl text-sm text-text-body flex items-start gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {order.receipt_url ? (
                      ...
                      <span className="text-sm text-text-muted">No receipt uploaded</span>
                    )}
                  </div>

                  {/* Total Amount */}
                  <div className="bg-warm-100 rounded-xl p-3 flex justify-between items-center border border-warm-200">
                    <span className="text-sm font-medium text-text-body">Total Amount</span>
                    <span className="text-2xl font-bold text-accent">RM{Number(order.total_amount).toFixed(2)}</span>
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    <button
                      ...
                      className="flex-1 bg-green-600 hover:bg-green-700 text-white rounded-xl py-3 font-semibold transition-colors flex items-center justify-center gap-2"
                    >
